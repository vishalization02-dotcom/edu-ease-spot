      ...
      <div className="grid md:grid-cols-2 gap-4">
        <Card className="p-5">
          ...
          <div className="text-sm space-y-1">
            <div>
              <span className="text-muted-foreground">Name:</span> {s.parent_name || "—"}
            </div>
            ...
            <div>
              <span className="text-muted-foreground">Joined:</span> {s.joining_date}
            </div>
        ...
        <Card className="p-5">
          ...
          <div className="grid grid-cols-3 gap-2 text-center">
            <div className="rounded-xl bg-success/5 py-3">
              <div className="text-2xl font-semibold text-success">{present}</div>
              <div className="text-xs font-medium text-muted-foreground">Present</div>
            </div>
            <div className="rounded-xl bg-destructive/5 py-3">
              <div className="text-2xl font-semibold text-destructive">{absent}</div>
              <div className="text-xs font-medium text-muted-foreground">Absent</div>
            </div>
            <div className="rounded-xl bg-primary/5 py-3">
